...
import Link from 'next/link'
import { Mail, MapPin, ArrowUp, Send, Heart } from 'lucide-react'
import { personalInfo } from '@/data/personal-info'
import { socialLinks } from '@/data/social-links'
...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-6 lg:col-span-2">
            <div>
              <h3 className="text-2xl font-bold bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent mb-4 animate-gradient bg-[length:200%_auto]">
                {personalInfo.name}
              </h3>
            ...
            <div className="space-y-3">
              <div className="flex items-center text-gray-300 hover:text-white transition-colors group cursor-pointer">
                <MapPin className="w-5 h-5 mr-3 text-blue-400 group-hover:scale-110 transition-transform" />
                {personalInfo.location}
              </div>
              <a 
                href={`mailto:${personalInfo.email}`}
              ...
              >
                <Mail className="w-5 h-5 mr-3 text-purple-400 group-hover:scale-110 transition-transform" />
                {personalInfo.email}
              </a>
            </div>
            ...
            <div className="mt-6">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-2.5 bg-gray-800/50 border border-gray-700 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all text-white placeholder-gray-500"
                />
                <button
                  onClick={handleSubscribe}
                  disabled={isSubscribing}
                  className="px-4 py-2.5 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg hover:shadow-lg hover:shadow-blue-500/50 transition-all hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isSubscribing ? (
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.name}>
                  ...
                  >
                    <span className="w-0 group-hover:w-6 h-px bg-gradient-to-r from-blue-400 to-purple-400 mr-0 group-hover:mr-3 transition-all duration-300"></span>
            ...
            <div className="space-y-3">
              {socialLinks.map((link) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex items-center space-x-3 px-4 py-3 rounded-xl bg-gray-800/50 border border-gray-700/50 hover:bg-gradient-to-r hover:from-blue-600 hover:to-purple-600 hover:border-transparent transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg hover:shadow-blue-500/25"
                >
                  <span className="text-gray-400 group-hover:text-white transition-colors group-hover:scale-110 duration-300">
                    {getIcon(link.name)}
                  </span>
                  <span className="text-gray-300 group-hover:text-white font-medium transition-colors">
                    {link.name}
        ...
        <div className="relative border-t border-gray-700/50 pt-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-gray-400 text-sm">
            ...
            <p className="flex items-center gap-2 text-center md:text-right">
              Crafted with 
              <Heart className="w-4 h-4 text-red-400 animate-pulse inline" fill="currentColor" /> 
              and creativity
            </p>
          </div>
        </div>
      ...
      <button
        onClick={scrollToTop}
        className="fixed bottom-8 right-8 p-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full shadow-lg hover:shadow-xl hover:shadow-blue-500/50 transition-all hover:scale-110 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900 z-50"
