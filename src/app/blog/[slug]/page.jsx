...
export default function BlogPostPage({ params }) {
  ...
  // Now safely calculate related posts
  const relatedPosts = blogPosts
    .filter(p => p.id !== post.id && p.tags.some(tag => post.tags.includes(tag)))
    .slice(0, 3)
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        ...
        <article className="prose prose-lg prose-blue max-w-none mb-16">
          ...
          {/* Content will be dynamically rendered from MDX files */}
          <div className="space-y-6 text-gray-700 leading-relaxed" dangerouslySetInnerHTML={{ __html: post.content }} />
        </article>
